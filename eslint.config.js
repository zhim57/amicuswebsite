module.exports = [
  { ignores: ['node_modules/**', 'public/**', 'src/js/generate_*.js', 'src/js/test_soap.js', '.qa/**', '.npm/**'] },
  {
    ...
    languageOptions: {
      ...
      globals: Object.fromEntries(['require', 'module', '__dirname', 'process', 'console', 'Buffer', 'URL', 'window', 'document', 'navigator', 'location', 'Element', 'HTMLElement', 'HTMLDetailsElement', 'Node', 'innerWidth', 'test', 'expect', 'beforeAll', 'beforeEach', 'afterAll', 'afterEach', 'jest'].map(name => [name, 'readonly']))
    },
